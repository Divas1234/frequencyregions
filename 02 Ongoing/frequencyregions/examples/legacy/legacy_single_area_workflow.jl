...
# --- Workflow Functions ---
# Legacy example retained outside src for reference.
...
function get_inertiatodamping_functions(droop_parameters)
    ...
    initial_inertia, factorial_coefficient, time_constant, droop, ROCOF_threshold, NADIR_threshold, power_deviation = get_parameters(flag_converter)
