if (@__MODULE__) == Main
	...
	using .FrequencyRegions: MultiAreaSystem, ControllerConfig, TieLine,
		build_ieee_2area_kundur, converter_forming_configurations,
		create_computation_config, execute_multiarea_workflow,
		print_multiarea_summary, execute_dynamic_multiarea_workflow,
