...
VERTICES_PATH = PROJECT_ROOT / "res" / "single_area" / "all_vertices.txt"
OUTPUT_DIR = PROJECT_ROOT / "fig" / "single_area"
...
plt.savefig(OUTPUT_DIR / "polyhedra_3d.svg",
            dpi=300, bbox_inches='tight', transparent=True)
plt.savefig(OUTPUT_DIR / "polyhedra_3d.pdf",
            dpi=300, bbox_inches='tight', transparent=True)
