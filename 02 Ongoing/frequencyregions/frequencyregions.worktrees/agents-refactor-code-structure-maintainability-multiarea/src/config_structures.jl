...
Parameters for an individual area in a multi-area system.
"""
struct AreaParameters
	...
	rocof_threshold::Float64
	nadir_threshold::Float64
	power_deviation::Float64 # Power deviation IF disturbance is in this area
	tieline_stiffness::Float64 # Synchronizing power coefficient T_ij
end

"""
	MultiAreaConfig

Configuration for a multi-area system frequency analysis.
"""
struct MultiAreaConfig
	areas::Vector{AreaParameters}
	tie_line_limits::Dict{Tuple{String, String}, Float64} # Optional tie-line constraints
	disturbance_area_name::String # Name of the area where the disturbance occurs
	default_tieline_stiffness::Float64 # Fallback for inter-area stiffness
end
