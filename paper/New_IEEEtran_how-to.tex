...
% The essence of aforementioned frequency-oriented studies is actually the process of delimiting suitable multidimensional frequency parameters. The most common technical approach is to construct a set of frequency dynamic constraints, usually formatted as a combination of frequency parameters, in accordance to the SFR requirements. Then the system stability are determined by comparing RoCoF, nadir, and QSS with the corresponding preselected frequency thresholds.

A primary objective of frequency-oriented studies is to determine the safety of frequency dynamic processes, as characterized by multidimensional frequency parameters. A conventional approach involves establishing dynamic frequency criteria, encompassing constraints on RoCoF, nadir, and QSS, typically expressed as relationships between these key frequency parameters, to ensure frequency security. System stability is then assessed by evaluating whether the observed frequency dynamics remain within the feasible region defined by these criteria.
