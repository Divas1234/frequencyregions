...
\begin{newsubequations}\label{eqn:7}
	\begin{align}
		...
		&\mathcal{Q}(\varDelta f(t-\delta t)|\varDelta p(t_0\!:\!t-\delta t);\varDelta \omega)  \label{eqn:7b}
	\end{align}
\end{newsubequations}

Again, by supposing the recursive type of the importance density and sequentially transferring it as \eqref{eqn:7b}, the similar recursive form of importance weight can be derived as,
