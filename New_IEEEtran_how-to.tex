...
\begin{small}
	\begin{align}\label{eqn:10}
		            & 2{H_{\varSigma}^{-1}}{\varDelta p_{step}}\leq \overline{\gamma}_{rocof}, \forall g, t                                                                                                                    \\
...
\begin{small}
	\begin{align}\label{eqn:13}
		 ...
		 & \qquad\,\,\,\, \varDelta f(t) \propto \mathcal{P}(\varDelta f(t)|\varDelta p(t_0:t); \varDelta \omega) \,in\, \textrm{\cref{eqn:7a}}
	\end{align}
\end{small}
