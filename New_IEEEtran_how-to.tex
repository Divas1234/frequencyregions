...
The RoCoF denoted by \(\varDelta f^{\prime} (t)\) aims to mitigate the possible rapid changes in the inertia response.
...
\begin{small}
	\begin{align}\label{eqn:10}
		...
		\rightarrow & \sum_{g\in\mathcal{G}}H_{g}x_{g,t} \!\geq\! \frac{1}{2}{\varDelta p_{{step} }}{\overline{\gamma}_{rocof}^{-1}} \!-\! \sum_{w\in\mathcal{W}} H_{w}, \forall g, t \notag
	\end{align}
\end{small}
...
The FCR constraint aims to ensure sufficient frequency reserves provided by homogeneous generators concerning additional output under primary frequency response. Substituting \cref{eqn:3a,eqn:3b,eqn:2f} into 
