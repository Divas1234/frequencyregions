...
\begin{newsubequations}\label{eqn:2}
	\begin{align}
		M_{\varSigma } \varDelta f^{\prime}(t) & +D_{\varSigma} \varDelta f(t)=\varDelta p(t)                                                                                        \\
		\varDelta p(t)                         & =\varDelta p_{step}-\varDelta p_{G}(t)-\varDelta p_{W}(t)-\varDelta p_{E}(t)                                                        \\
...
\begin{newsubequations}\label{eqn:3}
	\begin{align}
		\varDelta f(t + \delta t) & =\varDelta f(t)+M_{\varSigma}^{-1}\bigl(\varDelta p(t)-D_{\varSigma} \varDelta f(t)\bigr) \delta t + \delta \omega\delta t \label{time-discretized SFR: swing equation} \\
		\varDelta p(t)            & =\varDelta p_{{step}}-\varDelta p_{G}(t)-\varDelta p_{W}(t)-\varDelta p_{E}(t) \label{time-discretized SFR: mismatch power}                                             \\
	\end{align}
\end{newsubequations}
...
\begin{newsubequations}
	\begin{align}
		 & \mathcal{P}(\varDelta f(t) | \varDelta p(t_0: t; \mu_1,\sigma_1))=                                                                                                                                                                            \\
		 & \frac{\mathcal{P}(\varDelta f(t+\delta t) | \varDelta p(t_0: t; \mu_1,\sigma_1)) \mathcal{P}(\varDelta p(t+\delta  t) | \varDelta f(t+\delta t; \mu_1,\sigma_1))}{\mathcal{P}(\varDelta p(t+\delta t) | \varDelta p(t_0: t; \mu_2,\sigma_2))}
	\end{align}
\end{newsubequations}
